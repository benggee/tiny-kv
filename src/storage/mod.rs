...
/// Object Abstract
pub trait Storage {
    /// Get value use key from HashTable
    fn get(&self, table: &str, key: &str) -> Result<Option<Value>, KvError>;
    /// Set value and return old value from HashTable
    fn set(&self, table: &str, key: String, value: Value) -> Result<Option<Value>, KvError>;
    /// Key isexists
    fn contains(&self, table: &str, key: &str) -> Result<bool, KvError>;
    /// Delete key from HashTable
    fn del(&self, table: &str, key: &str) -> Result<Option<Value>, KvError>;
    /// for-each HashTable and get all pairs
    fn get_all(&self, table: &str) -> Result<Vec<Kvpair>, KvError>;
    /// for-each HashTable and get Iterator for Kvpair
...
mod tests {
    ...
    /*fn test_get_iter(sotre: impl Storage) {
        store.set("t2", "k1".into(), "v1".into()).unwrap();
        store.set("t2", "k2".into(), "v2".into()).unwrap();
